...
const Blog = () => {
  ...
  return (
      <div className='w-full flex justify-center '>
       ...
       <div className='w-full  py-20 banner'><h1 className='lg:text-6xl md:text-5xl text-4xl font-semibold text-center  z-30'>Discover the latest news</h1>
       <p className='text-[grey] text-center py-10'>Learn about Metax Digital and how we are changing <br /> the money markets for digital assets.</p></div>
