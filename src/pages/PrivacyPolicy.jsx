...
<MetaData metaData={'Metax Digital | Privacy Policy'}/>
...
It is imperative that you carefully read and comprehend the information below regarding our handling of your personal data. For any inquiries, please reach out to us via email at <a href="mailto:support@metaxpayments.com" className='text-btnBg'>support@metaxpayments.com</a>.</p>
      </div>
...
<p className='text-[grey]'>We gather information when you:
...
<p className='text-[grey] pt-5'>
If you are not the intended recipient of this Privacy Policy, please review the privacy practices of the entity responsible for controlling your personal data. MetaX may also be involved in the handling of your information in certain cases as outlined in this policy.</p>
...
<p className='text-[grey] '>
    <span className='text-white font-medium'>Fulfillment of Our Contract:  </span>We utilize the collected data to establish your customer record and effectively manage your account. Personal information is employed to verify your identity, and in certain instances, we may share some or all of your data with third parties. These may include fraud prevention agencies, anti-money laundering organizations, credit reference agencies, law enforcement, regulatory bodies, government departments, and providers of our sales or servicing platforms.
</p>
<p className='text-[grey] '>
    <span className='text-white font-medium'>Protection of Legitimate Interests: </span> Processing of personal information is conducted to safeguard our legitimate interests, provided such interests do not unduly compromise your rights and freedoms. These interests encompass the improvement of our services, protection of both our and your data through our IT and security systems, and the initiation or preparation for litigation procedures.
</p>
<p className='text-[grey] '>
    <span className='text-white font-medium'>Compliance with Legal Obligations: </span>The data enables us to fulfill our legal and regulatory obligations, encompassing compliance with the Electronic Money Regulation, Money Laundering Law, Tax laws, and other applicable statutes. As a regulated entity under FINTRAC in Canada, we adhere to its requirements, utilizing your personal information to prevent fraud and money laundering.
</p>
<p className='text-[grey] '>
    <span className='text-white font-medium'>Communication: </span>Your personal data is utilized for communication regarding your account, providing service-related updates, and delivering necessary notifications. While we aim to leverage our e-banking platform for communication, certain situations may necessitate contacting you in a specific manner as dictated by regulations.
</p>


<p className='text-[grey]'>
    <span className='text-white font-medium'>Troubleshooting, Analysis, Testing, Research, and Statistical/Survey Purposes: </span>We employ your data for a range of purposes, including troubleshooting, conducting data analysis, testing, research, and gathering statistical and survey data.

</p>
<p className='text-[grey] '>
    <span className='text-white font-medium'>Marketing: </span> With your explicit permission, we may utilize your information for marketing purposes. This involves identifying products and services that may align with your interests, ensuring a tailored and relevant approach to our marketing efforts.

</p>

<p>Your privacy and data protection are paramount to us, and we operate in accordance with applicable laws and regulations to safeguard your information.</p>

</section>

<section className='py-10'>
    <h3 className='text-xl'>Retention Period</h3>

    <p className='text-[grey] pt-2'>The retention of personal data at MetaX is contingent upon various purposes and is subject to rigorous standards and regulations. In essence, personal data is retained for the duration necessary to provide the requested services, fulfill relevant legal, accounting, or reporting requirements, investigate potential fraud, comply with anti-money laundering and counter-terrorism financing laws, and ensure you have a reasonable opportunity to access your personal data.</p>
    <p className='text-[grey] pt-2'>In the context of marketing, personal information provided for such purposes will be retained until you opt-out or until we identify inaccuracies in the data.</p>

    <h3 className='text-xl pt-5'>Disclosure of Your Personal Data</h3>
    <p className='text-[grey] pt-2'>MetaX diligently collects your personal information to execute requests, deliver services, and meet contractual and legal obligations.</p>
    <p className='text-[grey] pt-2'>Your personal data remains confidential and is not shared with external parties unless deemed essential for our business operations, to fulfill requests, provide services, or mandated by law. Instances where disclosure may be necessary include:
...
Rest assured, MetaX prioritizes the security and confidentiality of your personal data and only engages in disclosures when essential for the smooth operation of our services or mandated by legal and regulatory obligations.</p>
<h3 className='text-xl pt-5'>Countries Where Your Data May Be Transferred</h3>
<p className='text-[grey] pt-2'>MetaX, being a globally-reaching company, may process your personal data in the local country of our operations or in other countries where we or our partners operate worldwide, in accordance with legal permissions. Your personal data might be transferred from the European Union/European Economic Area (EU/EEA) or from another country imposing restrictions on personal information transfers to third countries or international organizations. Such transfers may occur under the following circumstances:</p> <h3 className='text-xl pt-5'>Recognition of Adequate Data Protection Standards:</h3>
<p className='text-[grey] pt-2'>We may transfer data to jurisdictions acknowledged by the European Commission as possessing adequate data protection standards.</p> <h3 className='text-xl pt-5'>Agreements Based on Standard Contractual Clauses: </h3>
<p className='text-[grey] pt-2'> The recipient of the data may have signed an agreement based on the Standard Contractual Clauses. In cases where the recipient is a group company, binding corporate rules are in effect, supplemented by any necessary additional safeguarding measures.</p> <h3 className='text-xl pt-5'>Necessity for Contract Performance:</h3>
<p className='text-[grey] pt-2'>Data transfer may be necessary for the performance of a contract between the data subject and MetaX.
</p> <h3 className='text-xl pt-5'>Establishment, Exercise, or Defense of Legal Claims:</h3>
<p className='text-[grey] pt-2'>The transfer may be necessary for the establishment, exercise, or defense of legal claims.</p>
<p className='text-[grey] py-5'>Legally Recognized Grounds at EU Level: Any other legally recognized grounds at the EU level for transferring data to third countries.
...
You hold the following rights concerning the personal information we have about you. It's crucial to note that some of these rights apply only under specific conditions, and their applicability may be limited if we have a compelling interest, legal requirement, or data exemption due to confidentiality reasons.  <br />

1. Right to Access:

You have the right to request a copy of the personal data retained and confirmation from us about whether personal data is being processed. <br />

2. Right to Correction:

You can request the correction of inaccurate or incomplete personal data related to you. This includes correcting any incorrect personal data about you and completing any incomplete personal data in line with the processing purpose. <br />
...
However, the right to erasure does not apply if the processing is necessary for freedom of expression and information, compliance with a legal obligation, reasons of public interest, or for initiating, pursuing, or defending legal claims. <br />
...
You raised an objection to data processing, and confirmation is pending on whether our legitimate interest outweighs your rights. <br />
5. Right to Object:
...
If we process your personal data based on your consent, you have the right to withdraw it at any time. If there's another lawful basis for processing your data, we may continue to do so. Withdrawal resulting in the inability to provide services will be communicated.</p>
<p className='text-[grey] '>7. Right to File a Complaint:

If you have complaints about data use or the exercise of your rights, please contact our Data Protection Officer at the provided contact details. We will promptly investigate and respond to your complaint.</p>
</section>
