...
const Institutional = () => {
  ...
  <img src={BgImg} alt="" className='absolute xl:top-50 top-72 z-10' />
          ...
          <div className='flex flex-col items-center pb-10 xl:pb-0 gap-10'>
              ...
              <p className='text-center md:text-[17px] text-[15px]'>Redefine the landscape of challenges and opportunities in the dynamic Web3 payment<br className='hidden lg:block'/> world with Skyline Digital!</p>
  ...
  <p className='text-[silver] pt-5 lg:w-[80%]'>Skyline Digital elevates your institutional strategy with the tools and support needed to unlock the full potential of your crypto investments.</p>
  </div>
  ...
  <div className='lg:w-[48%] flex flex-col lg:items-end w-full'>
    ...
    <div>
      <span className='text-btnBg text-md md:text-2xl leading-18'>Diversif</span><span className='text-v3 text-md md:text-2xl '>y you</span><span className='text-v4 text-md md:text-2xl'>r portfolio</span></div> 
          ...
          <p className='text-[silver] pt-10 lg:w-[80%]'>Discover the vast potential of crypto investments through Skyline Digital. Whether you are interested in established crypto enterprises or exploring the decentralized possibilities of DAOs.</p>
  <p className='text-[silver] pt-5 lg:w-[80%]'>Skyline Digital equips you with the knowledge and access needed to make informed and strategic investments.
...
<div className='flex flex-col gap-1 md:gap-5 md:pl-10 pl-5 lg:w-full justify-center'>
        ...
        Skyline Digital offers cutting-edge crypto solutions, ensuring the safety and integrity of your digital investments.
        </p>
...
{/* now another endss */}
  ...
  <h1 className='lg:text-6xl md:text-5xl text-4xl text-center font-medium md:leading-18 leading-10'>Redefine your institutional crypto<br className='hidden md:block'/> engagement by charting your course <br className='hidden md:block'/>with Skyline Digital
  </h1>
