...
const Blog1 = () => {
  return (
    <div className='relative blogContent h-[3900px] md:h-[3850px] lg:h-[3800px] bg-black z-[-2]' >
...
<h1 className='lg:text-5xl text-4xl font-semibold text-center  z-30 pt-10'>How to manage a fully decentralized operations</h1>
      ...
      <div className='absolute flex justify-center blogStartSec  w-full top-[750px] md:top-[950px] lg:top-[1700px]'>
<main className='w-[95%] md:w-[90%] xl:w-[85%] width-blog'>
