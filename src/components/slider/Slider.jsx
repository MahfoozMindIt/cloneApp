  ...
  return (
    <div className="slider">
      <div className="slider-track">
        ...
        <div className="item flex gap-10 text-5xl md:text-8xl font-medium"> <span>|</span> <span className='text-v4'><span className='text-v3'>3rd Party </span>Payments</span> </div>
