...
const NavPlatform = () => {
  ...
  return (
    <>
        <div className="bg-[#EBEBEB] text-black flex justify-center w-full py-10">
...
<button className='bg-hoverBg py-4 px-5 text-white rounded-full'>Sign up</button>
<button className='bg-btnBg py-4 px-5 text-white rounded-full'>Sign in</button>
           </div>
        </div>
        </div>
